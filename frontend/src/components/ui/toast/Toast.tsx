...
const Toast: React.FC<ToastProps> = ({ toast, onClose }) => {
  ...
  return (
    <div
      className={`
        rounded-xl border p-4 shadow-lg transition-all duration-300 ease-in-out
        ${variantClasses[toast.variant].container}
        ${
    ...
    >
      <div className="flex items-start gap-3">
        <div
          className={`-mt-0.5 flex-shrink-0 ${variantClasses[toast.variant].icon}`}
        >
          {icons[toast.variant]}
        </div>
